...
class ScoringFunction:
    ...
    def __init__(self, **kwargs):
        ...
        [1] introduces a property of many commonly used log-likelihood ratio scan statistics
        called Additive linear-time subset scanning (ALTSS) that allows for
        exact of efficient maximization of these statistics over all subsets of the data,
        without requiring an exhaustive search over all subsets and
        allows penalty terms to be included.

        [1] Speakman, S., Somanchi, S., McFowland III, E., & Neill, D. B. (2016).
        ...
        ), f"Expected one of {directions}, got {self.direction}"
    ...
    def score(
        ...
        The alternative hypothesis of MDSS assumes that
        there exists some constant multiplicative factor q > 1
